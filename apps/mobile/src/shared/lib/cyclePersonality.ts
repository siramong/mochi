...
const cyclePersonalityMap: Record<CyclePhase, MochiCyclePersonality> = {
  menstrual: {
    ...
    studyTip: 'Prioriza bloques cortos y repaso suave. Hoy no necesitas forzarte con temas complejos.',
    exerciseTip: 'Elige yoga, movilidad o caminata tranquila. Tu cuerpo agradecerá un ritmo gentil.',
    cookingTip: 'Te vienen bien recetas con hierro y efecto antiinflamatorio. Un poco de chocolate negro también está bien.',
    habitTip: 'Si no completas todo hoy, está bien. Celebramos lo que sí lograste.',
    moodNote: 'Es normal sentirte más sensible durante esta fase. Estoy contigo.',
  ...
  folicular: {
    ...
    phaseColor: '#34d399',
    morningMessage: 'Tu energía está subiendo. Es un gran momento para empezar algo nuevo.',
    motivationMessages: [
    ...
    studyTip: 'Excelente fase para estudiar temas nuevos, memorizar y empujar proyectos grandes.',
    exerciseTip: 'Prueba fuerza o cardio más intenso. Tu cuerpo suele responder muy bien ahora.',
    cookingTip: 'Anímate a recetas nuevas y creativas. Tu lado explorador está encendido.',
    habitTip: 'Buena etapa para construir hábitos nuevos y consolidar rutinas.',
    moodNote: 'Tu motivación puede sentirse más estable en esta fase. Úsala a tu favor.',
  ...
  ovulatoria: {
    ...
    studyTip: 'Muy buena fase para exposiciones, exámenes y actividades en equipo.',
    exerciseTip: 'Si te sientes bien, esta es tu ventana para retos intensos y entrenos potentes.',
    cookingTip: 'Prueba recetas coloridas y para compartir. Tu energía social acompaña.',
    habitTip: 'Completar tus hábitos suele fluir más fácil ahora. Capitaliza este impulso.',
    moodNote: 'Puedes sentir más seguridad y claridad. Úsala para tareas clave.',
  ...
  lutea: {
    ...
    studyTip: 'Ideal para tareas de detalle, revisión, organización y cierres pendientes.',
    exerciseTip: 'Puedes priorizar pilates, natación o intensidad baja-media según cómo te sientas.',
    cookingTip: 'Recetas reconfortantes y carbohidratos complejos pueden ayudarte a sentirte mejor.',
    habitTip: 'Quédate con lo esencial. Cumplir lo básico también es una victoria.',
    moodNote: 'Es común notar más sensibilidad emocional en esta fase. Respira, aquí estoy contigo.',
  ...
  unknown: {
    ...
    exerciseTip: 'Muévete según tu energía disponible. Lo importante es la constancia.',
