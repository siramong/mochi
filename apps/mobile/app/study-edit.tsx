...
export function EditStudyBlockScreen() {
  ...
  const loadBlock = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'No se pudo cargar el bloque')
    } finally {
      setLoading(false)
    }
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      showAlert({
        title: 'Error',
        message: err instanceof Error ? err.message : 'No se pudo actualizar el bloque',
    ...
    <>
      <ScrollView className="flex-1 bg-purple-100">
        <View className="px-5 py-6">
          ...
          <Text className="text-3xl font-extrabold text-purple-900">Editar bloque de estudio</Text>
          ...
          {loading ? (
            <View className="mt-10 items-center">
              ...
              <Text className="mt-3 text-sm font-semibold text-purple-700">Cargando bloque...</Text>
            </View>
          ) : error ? (
            ...
            <>
              ...
              >
                {saving ? (
                  ...
                  <Text className="text-center text-lg font-extrabold text-white">Guardar cambios</Text>
                )}
              </TouchableOpacity>
            </>
          )}
